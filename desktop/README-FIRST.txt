FinCompiler for Windows (portable)
==================================

1. Extract the full ZIP file before running it.
2. Double-click FinCompiler.exe. Python is not required.
...
Your uploads, mapping memory, rate cache and outputs are written to the
